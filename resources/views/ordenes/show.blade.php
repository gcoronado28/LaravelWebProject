...
<div class="container">
    <div class="my-3 p-3 bg-white rounded shadow-sm">
      ...
      <form class="m-4">
        ...
        <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Agregar Platos</button>
    ...
    <div class="bg-white rounded shadow-sm border p-3 mb-3">
      <h5 class="text-center mb-2">Platos de la órden</h5>
